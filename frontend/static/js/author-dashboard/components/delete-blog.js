  ...
  return `
    <div class="post-item" data-post-id="${post.id}">
      ...
      <div class="post-item-actions">
        <button class="edit-post" type="button" data-action="edit">Edit</button>
        <button class="delete-post" type="button" data-action="delete">Delete</button>
      </div>
    </div>
  `;
}
...
export function wirePostActions(container, { onEdit, onDelete } = {}) {
  if (!container) return;
